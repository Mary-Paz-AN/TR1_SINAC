...
const HomeScreen = () => {
    ...
    return (
        ...
        <View style={{marginTop:20}}  >
            ...
            <View style={[{ flexDirection: isSmallScreen ? 'column' : 'row', marginTop:20}]}>
...
const styles = StyleSheet.create({
    background2: {
        width: '100%',     // Asegurar que la imagen ocupe el ancho completo de su contenedor
        height: '100%',    // La imagen debe ocupar todo el espacio disponible
        flex: 1,           // Ocupar el 50% de la pantalla
